...
public class ScheduleAdapter extends RecyclerView.Adapter<ScheduleAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.tv_schedule_title.setText(list.get(position).getTitle());
        holder.tv_schedule_content.setText(list.get(position).getTitle());
    }
                        ...
                        builder.setSingleChoiceItems(new String[]{"수정", "삭제"}, 2, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (which == 0){
                                    ...
                                    ((ScheduleActivity)context).changeFragment(new ScheduleFragment3());
                                    dialog.dismiss();
                                }else if (which == 1){
                                    // 1 번지 == 삭제
